...
export declare namespace Avito {
    const checkAd: (options: Options) => (url: string, attemps?: number) => import("fp-ts/lib/TaskEither").TaskEither<import("./utils/axios").UnknownAxiosError | import("axios").AxiosError<any, any>, AdResult>;
